...
<button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
    class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-8 ">
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <h3 class="text-xl font-semibold dark:text-gray-700">{{ $item->course_name }}</h3>
            <p class="dark:text-gray-700">
                {{ \Illuminate\Support\Str::limit($item->deskripsi, 50, $end='...') }}
            </p>
            <div class="mt-4">
                <p class="dark:text-gray-700">Tanggal Mulai: {{ $item->tanggal_mulai }}</p>
                <p class="dark:text-gray-700">Tanggal Selesai: {{ $item->tanggal_selesai }}</p>
                <p class="dark:text-gray-700">Pengajar: {{ $item->teacher_name }}</p>
                <p class="dark:text-gray-700">Jumlah Peserta: {{ $item->jumlah_peserta }}</p>
            </div>
    ...
    @endforeach
    @else
    <p class="text-gray-400">Tidak ada course yang tersedia.</p>
    @endif
</div>
