...
<div class="mb-6 flex justify-between items-center">
    <a href="{{ url("/teacher/courses") }}" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4
    ...
    <a href="{{ route('teacher.contents.create', ['courseId' => $course->id]) }}" class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none dark:focus:ring-green-800 font-medium rounded-lg
...
<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md p-4 rounded-lg mb-4 mt-4">
        ...
        <a href="{{ route('teacher.contents.edit', ['content' => $content->id]) }}"
