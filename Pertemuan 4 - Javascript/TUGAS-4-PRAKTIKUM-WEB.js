...
function CipherText(text, n) {
  ...
  console.log(CipherText("abc", 1));
  console.log(CipherText("Indonesia", 13)); 
  ...
  const angkaDesimal = 14;
  const angkaBiner = numberToBinary(angkaDesimal);
